...
public class YAxisRenderer extends AxisRenderer {
    ...
    private void renderIndicatorBlock(Canvas c, float positionX, float[] positions, float offset) {
        ...
        if (ourRange > 10 && ourRange < 490) {
            c.drawRect(positionX - 15, ourRange - 25 + offset, positionX + 110, ourRange + 7 + offset, paint);
            c.drawText("" + limitIndicatorBlock, positionX - 2, ourRange + offset, mAxisLabelPaint);
        }
    }
}
